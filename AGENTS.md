...
**Kusoma** — Kitabu hiki ni cha somo la Kusoma kwa wanafunzi wa Darasa la Pili katika shule za English Medium, kimeandaliwa na Taasisi ya Elimu Tanzania na hivyo asili yake ni Tanzania, na kimeandikwa kwa lugha ya Kiswahili. Kinafundisha stadi za msingi za lugha kama kusikiliza, kuzungumza, kutambua herufi mwambatano, kusoma kwa ufasaha, na kusoma kwa ufahamu kwa kiwango cha elimu ya msingi cha awali. Maudhui yake yanajengwa kwa hadithi, mazungumzo, nyimbo, ngonjera, picha na mazoezi mbalimbali yanayosisitiza usafi, nidhamu, usalama, ushirikiano, heshima na upendo, kwa mtazamo wa ujifunzaji shirikishi na wa vitendo.
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha Wizara ya Elimu, Sayansi na Teknolojia kwa kitabu cha Kusoma Kitabu cha Mwanafunzi Darasa la Pili, kikiwa na namba 1607, tarehe 11 Septemba 2024 na sahihi ya Kamishna wa Elimu.",
  "gl001": "afisa",
  "gl001_def": "mtu mwenye kazi au cheo maalumu serikalini au taasisi fulani.",
  "qz001_que": "Moza alijifunza nini mwishoni mwa hadithi?",
  "qz001_o0": "1) Uchafu haufai",
  "qz001_o0_exp": "✅ Hongera! Hili ndilo funzo kuu la hadithi. Moza alipompata mwanasesere wake, alijifunza kuwa uchafu haufai."
}
```
...
```json
{
  "afisa": {
    "word": "afisa",
    "definition": "mtu mwenye kazi au cheo maalumu serikalini au taasisi fulani.",
    "variations": ["afisa","afisa mazingira"],
    "emoji": "👨‍💼📋"
  }
}
```
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Moza alijifunza nini mwishoni mwa hadithi?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Hongera! Hili ndilo funzo kuu la hadithi. Moza alipompata mwanasesere wake, alijifunza kuwa uchafu haufai." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Uchafu haufai</span>
    </label>
    <!-- more options... -->
</section>
